        ...
        <div className="headerInformation">
          ...
          <div className="factures">
            <div className="facture">
              ...
              <h3 style={{ color: "#9DC11E" }}>{data.facture_réglée} TND</h3>
            </div>
            <div className="facture">
              <h5>FACTURE À RÉGLER</h5>
              <h3 style={{ color: "#ED6B4E" }}>{data.facture_à_réglée} TND</h3>
            </div>
            <div className="facture">
              <h5>CHIFFRE D'AFFAIRES</h5>
              <h3 style={{ color: "#7DE3F5" }}>{data.chiffre_affaire} TND</h3>
            </div>
          </div>
        </div>
        <br />
