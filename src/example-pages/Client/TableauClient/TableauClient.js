...
export default function TableauClient({ rows }) {
          ...
          <TableBody>
            ...
            {(rowsPerPage > 0
              ...
              <TableRow key={row.id_client}>
                ...
                <TableCell align="center">{row.id_client}</TableCell>
                ...
                <TableCell align="center">
                  ...
                  <CachedIcon
                    ...
                    onClick={() => {
                      unArchiveFournisseur(row.id_client);
                    }}
                  />
                </TableCell>
              </TableRow>
              ...
              <TableRow key={row.id_client}>
                ...
                <TableCell align="center">
                  ...
                  <DeleteForeverIcon
                    ...
                    onClick={() => {
                      archiveFournisseur(row.id_client);
                    }}
                  />
                </TableCell>
              </TableRow>
  ...
  const unArchiveFournisseur = (id) => {
    ...
    setArchives(filterData(rows, 1));
    axios
      .post("http://localhost:4200/archiveClient", { Id: id, value: 0 })
      .then((res) => {});
  };
  const archiveFournisseur = (id) => {
    ...
    setArchives(filterData(rows, 1));
    axios
      .post("http://localhost:4200/archiveClient", { Id: id, value: 1 })
      .then((res) => {});
  };
  ...
  const findElements = (value) => {
    ...
    setClients(filterData(searchData, 0));
