...
const NewUsers = (props) => {
    ...
    return (
        <Card >
            <CardHeader 
            avatar={
                <h1 className="ubuntu">New Users</h1>
            }
            />
            <CardContent>
                ...
                {users.map((user) => (user.approved == 0) ? 
                    ...
                    <Grid container spacing={3}>
                        ...
                        <div>
                        {user.firstName}<br />
                        <span style={{fontSize:"0.7rem"}}>{user.phoneFix}</span>
                        </div>
                        </Grid>
